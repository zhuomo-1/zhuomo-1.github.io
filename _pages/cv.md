...
Projects
======
* **Algorithm research on real-world X-ray prohibited-item detection.** Prior-aware debiasing for severe head/tail class imbalance; few-shot continual learning for emerging object categories without catastrophic forgetting. Outputs: first-authored manuscript under review at IEEE TIFS.
